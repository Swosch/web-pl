                                    ...
                                    <tbody id="tabelCalendar">
                                        @forelse($calendars as $index => $calendar)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="action-buttons">
                                                        <button class="btn btn-sm btn-warning" onclick="editCalendar({{ $calendar->id }})">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                    ...
                                    <tbody id="tabelAgenda">
                                        @forelse($agendas as $index => $agenda)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="action-buttons">
                                                        <button class="btn btn-sm btn-warning" onclick="editAgenda({{ $agenda->id }})">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-warning btn-sm" onclick="editStruktur('{{ $struktur->id }}', '{{ asset('storage/' . $struktur->gambar) }}')">
                                                    <i class="fas fa-edit"></i> Edit
                                                </button>
                                                <form action="{{ route('admin.struktur.destroy', $struktur->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-sm" style="background-color: pink; border-color: pink;" onclick="return confirm('Apakah Anda yakin ingin menghapus struktur ini?')">
                                                        <i class="fas fa-trash"></i> Hapus
                                                    </button>
                                                </form>
                                            </td>
